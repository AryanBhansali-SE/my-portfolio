...
const EXPERIENCES = [
  {
    ...
    status: "active",
    metric: "Plain English → Live Enterprise Data — In Production",
    bullets: [
      "Built a dynamic NLQ system that takes plain-English questions from non-technical employees, identifies the query intent, constructs the SQL query accordingly, and returns the result in plain English.",
      "Designed a two-model Azure OpenAI architecture — one model for intent classification and query construction against Microsoft SQL Server, a second for formatting raw results into natural-language responses.",
