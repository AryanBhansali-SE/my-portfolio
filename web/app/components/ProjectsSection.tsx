...
const PROJECTS = [
  {
    ...
    problem: "The Problem",
    desc: "Personal productivity apps collect data but never learn from it. LUCID surfaces AI-driven insights from your logged habits, goals, and journal entries — creating a feedback loop that actually changes behaviour over time.",
    chips: ["React", "TypeScript", "Supabase", "LLM API"],
    ctaLabel: "View Live App",
    ctaHref: "https://lucidprivateai.lovable.app",
  },
  {
    type: "AI INFORMATION SYSTEM",
    title: "THE SIGNAL",
    subtitle: "AI · Capital · Consequence",
    problem: "The Problem",
    desc: "Information overload is the default. The Signal is an independent AI-powered publication at the intersection of AI and capital markets — live market tickers, original reporting, and an AI concierge that surfaces what actually matters.",
    chips: ["React", "TypeScript", "Supabase", "LLM API"],
    ctaLabel: "View Live App",
    ctaHref: "https://thesignalai.lovable.app",
  },
];
